...
$(WORK_DIR)/INFO: Makefile $(SPK_ICON)
	...
	@echo arch=\"$(SPK_ARCH)\" >> $@
	@echo distributor=\"cytec\" >> $@
	@echo distributor_url=\"https://cytec.us/spk/\" >> $@
ifeq ($(strip $(MAINTAINER)),cytec)
	@echo maintainer=\"cytec\" >> $@
	@echo maintainer_url=\"https://cytec.us/spk/\" >> $@
else
	@echo maintainer=\"cytec/$(MAINTAINER)\" >> $@
	@echo maintainer_url=\"https://cytec.us/spk/\" >> $@
endif
...
ifneq ($(strip $(BETA)),)
	@echo report_url=\"https://github.com/cytec/spksrc/issues\" >> $@
endif
ifneq ($(strip $(HELPURL)),)
...
ifeq ($(PUBLISH_API_KEY),)
	...
	curl -k -A "spksrc v1.0; $(PUBLISH_API_KEY)" \
