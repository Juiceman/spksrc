...
postinst ()
{
    ...
    # Setup database
    if [ "${SYNOPKG_PKG_STATUS}" == "INSTALL" ]; then
        ${MYSQL} -u root -p"${wizard_mysql_password_root}" -e "CREATE DATABASE ${MYSQL_DATABASE}; GRANT ALL PRIVILEGES ON ${MYSQL_DATABASE}.* TO '${MYSQL_USER}'@'localhost' IDENTIFIED BY '${wizard_mysql_password_nzedb}';"
    fi
...
preupgrade ()
{
    ...
    mv ${WEB_DIR}/${PACKAGE}/nzedb/config/settings.php ${TMP_DIR}/${PACKAGE}/
    mv ${WEB_DIR}/${PACKAGE}/resources/covers/ ${TMP_DIR}/${PACKAGE}/
    mv ${WEB_DIR}/${PACKAGE}/resources/nzb/ ${TMP_DIR}/${PACKAGE}/
...
{
    # Restore some stuff
    mv ${TMP_DIR}/${PACKAGE}/settings.php ${WEB_DIR}/${PACKAGE}/nzedb/config/
    mv ${TMP_DIR}/${PACKAGE}/covers ${WEB_DIR}/${PACKAGE}/resources/
    mv ${TMP_DIR}/${PACKAGE}/nzb ${WEB_DIR}/${PACKAGE}/resources/
    rm -fr ${TMP_DIR}/${PACKAGE}
